...
export default function OnboardingPage() {
  return (
    <div className='mx-auto flex w-full max-w-xl flex-col justify-center space-y-8 px-4 py-10 sm:px-6 lg:px-0'>
      ...
      <div className='absolute top-5 flex w-full justify-end px-50'>
